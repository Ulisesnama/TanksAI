...
{
	protected float currentRotationSpeed = 1.0f;
    ...
    protected void SetNavMeshAgent(Transform tankTransform)
    {
        if (tankTransform == null)
            return;
        this.navMeshAgent = tankTransform.GetComponent<UnityEngine.AI.NavMeshAgent>();
    ...
    public void FindNextPoint()
    {
		...
		this.destPosition = waypoints[rndIndex].position;
    }
